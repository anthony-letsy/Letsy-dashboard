                ...
                <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl shadow-[#635bff]/10 border border-white/20 p-8 sm:p-10">
                    ...
                    <form onSubmit={handleSignup} className="space-y-5">
                        ...
                        <div className="group">
                            ...
                            <p className="mt-2 text-[12px] text-[#425466]">
                        ...
                        {/* Terms notice */}
                        <p className="text-[12px] text-[#425466] text-center">
                            By creating an account, you agree to our{' '}
                            <span className="text-[#635bff] hover:underline cursor-pointer">Terms of Service</span>
                            {' '}and{' '}
                            <span className="text-[#635bff] hover:underline cursor-pointer">Privacy Policy</span>
                        </p>
                    </form>
